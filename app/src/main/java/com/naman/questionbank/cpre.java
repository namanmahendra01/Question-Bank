...
public class cpre extends AppCompatActivity {
    ...
    private static final String TAG = "cpre";


   @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cpre);
  ...
  Dexter.withActivity(this)
            ...
            public void onClick(View view) {
                ...
                call.collection(text2).document(text3)
                                                        ...
                                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                            if(documentSnapshot.exists()) {
                                                                ...
                                                                if (map.size() != 0) {
                                                                    ...
                                                                    value = x.getValue();
                                                                    Intent intent = new Intent(cpre.this, ViewActivity.class);
                                                                ...
                                                                {
                                                                    Toast.makeText(cpre.this,"Sorry!PDF is not available right now,We will try to make it available in future",Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                                            else
                                                            {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(cpre.this,"success",Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
        ...
        String[] subject1=getResources().getStringArray(R.array.paper2);
