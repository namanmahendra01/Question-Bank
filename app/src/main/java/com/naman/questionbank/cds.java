...
public class cds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                call.collection(text3).document(text2)
                                                        ...
                                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                            if(documentSnapshot.exists()) {
                                                                ...
                                                                if (map.size() != 0) {
                                                                    ...
                                                                    value = x.getValue();
                                                                    Intent intent = new Intent(cds.this, ViewActivity.class);
                                                                ...
                                                                {
                                                                    Toast.makeText(cds.this,"Sorry!PDF is not available right now,We will try to make it available in future",Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                                            else
                                                            {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(cds.this,"success",Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
        ...
        String[] subject1=getResources().getStringArray(R.array.cdssub);
