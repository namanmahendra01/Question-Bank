...
public class neet extends AppCompatActivity {
    ...
    private static final String TAG = "neet";
            ...
            public void onClick(View view) {
                ...
                firestore.collection(text4).document(text3)
                                                        ...
                                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                            if(documentSnapshot.exists()) {
                                                                ...
                                                                if (map.size() != 0) {
                                                                    ...
                                                                    value = x.getValue();
                                                                    Intent intent = new Intent(neet.this, ViewActivity.class);
                                                                ...
                                                                {
                                                                    Toast.makeText(neet.this,"Sorry!PDF is not available right now,We will try to make it available in future",Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                                            else
                                                            {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(neet.this,"success",Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
